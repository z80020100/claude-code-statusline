...
| 行  | 內容                                                                                |
| --- | ----------------------------------------------------------------------------------- |
| 1   | 狀態燈號，Claude Code 與 Statusline 兩者版本，各檢查啟用時於對應版本後加 `→ vX.Y.Z` |
...
| 符號 | 顏色 | 服務狀態             | 意義                     |
| ---- | ---- | -------------------- | ------------------------ |
| `✻`  | 綠色 | Operational          | 一切正常 — 可安心使用    |
| `◐`  | 金色 | Degraded Performance | 比平常慢                 |
| `▲`  | 珊瑚 | Partial Outage       | 部分功能受影響           |
| `■`  | 紅色 | Under Maintenance    | 計畫性維護進行中         |
| `✘`  | 紅色 | Major Outage         | 服務中斷                 |
| `✻`  | 灰色 | Unknown              | 尚未檢查或無法識別的狀態 |
